...
public class Mario extends GameObject {
    ...
    private final boolean FindDublicatesON = false;
...
//                this.playMusic("music/Ground.mp3");
                parent.amitsAudioPlayer.playMusic("Ground");

            } else {
//                this.playMusic("music/" + this.CurrentLevel.attribute + ".mp3");

                parent.amitsAudioPlayer.playMusic(CurrentLevel.attribute);
            }
        }
    ...
    public void update(long l) {
        ...
        if (this.bsInput.isKeyPressed(KeyEvent.VK_ENTER)) {
            ...
            parent.amitsAudioPlayer.smb_pause.play();
//            playSound("music/smb_pause.play();
        }
...
//        
    ...
    public void addSomeBrickFragmends(double x, double y) {
        ...
        parent.amitsAudioPlayer.smb_breakblock.play();

//        this.playSound("music/smb_breakblock.play();
    }
...
//        font.drawString(g ,"X  "+(int)player.getX()/32 + " Y "+(int)player.getY()/32, 21, 64 );
    ...
    public void SmoothScroll() {
        ...
        SmoothScroll = true;
        parent.amitsAudioPlayer.stopAllMusic();
        parent.amitsAudioPlayer.smb_world_clear.play();
    }
